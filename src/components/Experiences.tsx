...
const experiencesData = [
  ...
  },
  {
    ...
    description: [
      ...
      "Pilotage du projet TraAM 2024-2025 pour les académies de Bordeaux et Limoges.",
  ...
  },
  {
    ...
    dates: "2003 - 2011",
    description: [
      "Chargé de Travaux dirigés de Macro-économie, Micro-économie, Économie Politique, Démographie.",
      ...
      "Traitement des données d'enquêtes pour l'évaluation du programme National d'Infrastructures Rurales (PNIR) au Sénégal, en collaboration avec l'Université Gaston Berger, Saint-Louis, Sénégal.",
